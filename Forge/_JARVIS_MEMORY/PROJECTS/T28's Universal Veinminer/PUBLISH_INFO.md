# PUBLISH_INFO.md
# Información de Publicación para T28's Universal Veinminer

Este archivo contiene el texto base que se utilizará para la descripción del mod en plataformas como CurseForge y Modrinth.
...
- **Dynamic Detection:** Automatically detects ores and logs using Forge Tags (`Tags.Blocks.ORES` and `BlockTags.LOGS`), meaning it works seamlessly with most modded ores and trees out of the box!
- **Vanilla Integration:**
...
- **Highly Configurable (In-Game):**
  ...
  - **Custom Blocks (Commands):** Easily add or remove any block to the veinminer list using in-game commands with native auto-completion:
