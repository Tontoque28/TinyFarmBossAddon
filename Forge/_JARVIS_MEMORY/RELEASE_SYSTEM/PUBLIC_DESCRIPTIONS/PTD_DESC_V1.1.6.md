# Progressive Time Difficulty (PTD) - v1.1.6
...
**1. Visual Threat Indicators (New!)**
...
*   **Tier 1 (Smoke):** Hardened Mob (Factor 0.5 - 1.0).
*   **Tier 2 (Flame):** Dangerous Mob (Factor 1.0 - 2.0).
*   **Tier 3 (Soul Fire):** Extreme Threat (Factor > 2.0).

**2. Hardcore Rebalance (Updated!)**
...
**3. Creeper Exclusion**
*   **No More Buffed Creepers:** Creepers are now explicitly excluded from all difficulty buffs (Health, Damage, Armor).
*   **Why?** To ensure compatibility with mods that modify Creeper explosions (like Creeper Insta Boom) and prevent unfair one-shot mechanics.

**4. Armor Protection** Tired of your Netherite armor breaking in seconds?
...
*   **Defense:** Bosses no longer receive extra Armor or Knockback Resistance.
...
**7. Scalable Experience** Mobs drop more experience as they become stronger.
...
**8. Environmental Damage Scaling** The world itself is now your enemy. Environmental damage scales with the difficulty factor.
...
**9. Dynamic Difficulty Scaling** The mod adapts to your world's difficulty setting:
*   **Easy:** Mobs scale slowly (0.5% per day).
*   **Normal:** Balanced scaling (0.75% per day).
*   **Hard:** Faster scaling (1.0% per day).

**10. Hardcore Mode** For players seeking a brutal challenge.
*   **Activation:** `/progresstd hardcore true`
*   **Effect:** Fixed 1.2% daily scaling + **Massive Damage Bonus (x2.5)**.

***

## Admin Commands

_Important: All commands require operator (OP) permissions._
