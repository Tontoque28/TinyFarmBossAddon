...
• **Mod Compatibility & Anti-Crash** Safely capture and farm complex mobs from other mods (like MineColonies, Ice and Fire Dragons, Cataclysm, Terramity) and Vanilla Slimes without crashing your game or server. 

• **Customization (Config File)** The addon generates a configuration file that lets you:
  - **Whitelist:** Add any custom modded mob to be captured by the Lasso.
...
• **Commands** Includes `/tinyfarmbossaddon give <boss>` to quickly obtain a lasso with a boss already inside (useful for admins or testing).
