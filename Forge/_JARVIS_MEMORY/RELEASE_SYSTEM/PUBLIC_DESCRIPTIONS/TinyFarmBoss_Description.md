...
🔗 Original Mod: [https://www.curseforge.com/minecraft/mc-mods/tiny-mob-farm](https://www.curseforge.com/minecraft/mc-mods/tiny-mob-farm)
...
• **Custom Loot Tables** Ensures that bosses drop their valuable loot (Nether Stars, Dragon Eggs, Sculk Catalysts, Echo Shards) even in basic farms, bypassing the "player kill only" restriction.

• **Multipart Support** You can click on any part of the Ender Dragon (wings, head, tail) to capture it instantly.

• **Mod Compatibility (Anti-Crash System)** Safely capture and farm complex mobs from other mods (like MineColonies' Barbarians/Pirates or Ice and Fire Dragons) and Vanilla Slimes without crashing your game or server. The addon securely simulates their drops.
...
• **Commands** Includes `/tinyfarmboss give <boss>` to quickly obtain a lasso with a boss already inside (useful for admins or testing).
...
• Minecraft 1.20.1 • Forge • Tiny Mob Farm (Required Dependency)
